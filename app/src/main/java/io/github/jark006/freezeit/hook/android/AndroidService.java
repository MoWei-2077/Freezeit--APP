...
public class AndroidService {
    ...
    final static String CFG_TAG = "Freezeit[Config]:";
    final static String AMS_TAG = "Freezeit[AMS]:";
    final static String WIN_TAG = "Freezeit[WIN]:";
    final static String NMS_TAG = "Freezeit[Netd]:";
    final static String WAK_TAG = "Freezeit[AppOps]:";
    final static String DPC_TAG = "Freezeit[Display]:";
    final static String FGD_TAG = "Freezeit[Foreground]:";
