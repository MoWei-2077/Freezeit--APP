...
public class Settings extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BinderFreezerSwith = findViewById(R.id.switch_BinderFreezer);
    ...
    public void onResume() {
        ...
        new Thread(() -> {
            ...
            if (settingsVar[freezeModeIdx] > 4) settingsVar[freezeModeIdx] = 0;
            ...
            if (settingsVar[wakeupTimeoutIdx] > 120) settingsVar[wakeupTimeoutIdx] = 10;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case INIT_UI:
                    ...
                    InitSwitch(BinderFreezerSwith, BinderFreezerIdx);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.Rekernel_title) {
            Utils.textDialog(this, R.string.Rekernel_title, R.string.Rekernel_tips);
        } else if (id == R.id.checkReFreeze_title) {
