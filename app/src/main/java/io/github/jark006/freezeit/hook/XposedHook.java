...
public class XposedHook {
     ...
     * @param args         目标构造函数参数
     */
    public XposedHook(HookAction beforeMethod, HookAction afterMethod, Object... args) {
     ...
     * @param args         目标函数参数
     */
    public XposedHook(String methodName, HookAction beforeMethod, HookAction afterMethod, Object... args) {
